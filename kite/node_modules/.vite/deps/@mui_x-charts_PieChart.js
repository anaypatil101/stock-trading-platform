import {
  ...
  useSvgRef,
  useTicks
} from "./chunk-OA3YRMJV.js";
import {
  NoSsr_default
} from "./chunk-A7ZEETNM.js";
import {
  Popper_default
} from "./chunk-CK4M22AK.js";
import "./chunk-C4AR4E74.js";
import "./chunk-QONHCL37.js";
import {
  useThemeProps
} from "./chunk-TB6OOD4G.js";
import {
  Typography_default
} from "./chunk-MOVLTEDG.js";
import {
...
import "./chunk-QBCIVI5C.js";
import {
  useTheme
} from "./chunk-VGX6KWTJ.js";
import {
  _extends,
  clsx_default,
  init_RtlProvider,
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React12.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React12.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  const displayError = React18.useRef(false);
...
true ? ChartsText.propTypes = {
   ...
   * Text displayed.
   */
  text: import_prop_types8.default.string.isRequired
} : void 0;
  ...
  return (0, import_jsx_runtime10.jsxs)(XAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime10.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime10.jsxs)("g", {
        ...
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && showTickLabel && (0, import_jsx_runtime10.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime12.jsxs)(React32.Fragment, {
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React37.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React37.useMemo(() => {
...
function ChartsTooltip(inProps) {
  ...
  return (0, import_jsx_runtime17.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime17.jsx)(PopperComponent, _extends({}, popperProps, {
      className: classes.root,
      children: trigger === "item" ? (0, import_jsx_runtime17.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime17.jsx)(ChartsAxisTooltipContent, {
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime18.jsxs)("g", {
    ...
    }), (0, import_jsx_runtime18.jsx)(ChartsText, {
      style: _extends({
        pointerEvents: "none"
      }, labelStyle),
      text: label,
...
function LegendPerItem(props) {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React40.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
...
true ? DefaultChartsLegend.propTypes = {
  ...
  seriesToDisplay: import_prop_types15.default.arrayOf(import_prop_types15.default.shape({
    ...
    itemId: import_prop_types15.default.oneOfType([import_prop_types15.default.number, import_prop_types15.default.string]),
    label: import_prop_types15.default.string.isRequired,
    maxValue: import_prop_types15.default.oneOfType([import_prop_types15.default.instanceOf(Date), import_prop_types15.default.number]),
    minValue: import_prop_types15.default.oneOfType([import_prop_types15.default.instanceOf(Date), import_prop_types15.default.number]),
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime22.jsxs)(React44.Fragment, {
    ...
    }), (0, import_jsx_runtime22.jsx)("rect", _extends({
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime24.jsxs)(React46.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime24.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime24.jsx)(ChartsAxisHighlightPath, {
...
function PieArc(props) {
  ...
  return (0, import_jsx_runtime25.jsx)(PieArcRoot, _extends({
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime26.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index) => {
      ...
      return (0, import_jsx_runtime26.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime27.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime28.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime28.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
  ...
  return (0, import_jsx_runtime29.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime29.jsx)("g", {
        ...
        children: (0, import_jsx_runtime29.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime29.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime29.jsx)(PieArcLabelPlot, {
          innerRadius,
...
var PieChart = React57.forwardRef(function PieChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPieChart"
  });
  ...
  return (0, import_jsx_runtime33.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ...
    onHighlightChange,
    className,
    children: [(0, import_jsx_runtime33.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime33.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick,
      skipAnimation: skipAnimation2
    }), (0, import_jsx_runtime33.jsx)(ChartsOverlay, {
      loading,
      slots,
      slotProps
    }), (0, import_jsx_runtime33.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime33.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime33.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  }));
